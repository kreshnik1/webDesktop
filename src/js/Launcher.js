...
var CalculatorApplication = require('./calculator/CalculatorApplication');
var timerApplication = require('./timer/timerApplication');
/**
...
Launcher.prototype.createApplication = function(type, appOptions) {
    ...
    switch (type) {				
		 ...
		 case "calculator":
        {
          ...
          newApp = new CalculatorApplication(appOptions);
          newApp.init();
